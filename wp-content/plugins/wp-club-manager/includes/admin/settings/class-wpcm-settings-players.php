...
class WPCM_Settings_Players extends WPCM_Settings_Page {
	...
	public function get_settings() {
		...
		$settings = array(
			...
			array(
				'title' => __( 'Number', 'wp-club-manager' ),
				'desc' 		=> '',
			...
			array( 'title' => __( 'Display Player Stats', 'wp-club-manager' ), 'type' => 'title', 'desc' => __( '<p>Choose which player stats to display throughout the site.</p>', 'wp-club-manager' ), 'id' => 'players_stats' ),
		);
		...
		foreach ( $stats_labels as $key => $value ) {
			...
			$settings[] = array(
				'title' => __( strip_tags($value), 'wp-club-manager' ),
				'desc' 		=> '',
