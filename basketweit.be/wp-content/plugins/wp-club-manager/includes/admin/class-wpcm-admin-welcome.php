...
class WPCM_Admin_Welcome {
	...
	private function intro() {
		...
		<p class="wpclubmanager-actions">
			...
			<a class="docs button button-primary" href="<?php echo esc_url( apply_filters( 'wpclubmanager_docs_url', 'http://wpclubmanager.com/docs/', 'wp-club-manager' ) ); ?>"><?php _e( 'Docs', 'wp-club-manager' ); ?></a>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
	...
	public function about_screen() { ?>
		...
		<div class="wrap about-wrap">
			...
			<p class="about-description"><?php _e( 'This new version of WP Club Manager introduces a few new features, some minor performance improvements and a couple of bugfixes. Check the changelog for a full list of changes.', 'wp-club-manager' ); ?></p>
			...
			<div class="changelog">
				...
				<div class="wpcm-feature feature-section col three-col">
					...
					<h4><?php _e( 'Display Team Names', 'wp-club-manager' );?></h4>
					<p><?php _e( 'Get more clarity with the new team display names feature which enables you to set a name for each team in your club that will be displayed throughout the front-end of your site.', 'wp-club-manager' );?></p>

					<h4><?php _e( 'New Matches Shortcode List', 'wp-club-manager' );?></h4>
					<p><?php _e( 'More choice to display your fixtures and results with a new matches shortcode style option. You can choose between the original classic table layout or a new, modern list style.', 'wp-club-manager' ); ?></p>

					<div style="clear:both;width:100%;"></div>

					<img src="<?php echo WPCM_URL . 'assets/images/welcome/13-head2head.png'; ?>" class="wpcm-welcome-screenshots"/>

					<h4><?php _e( 'Head to Head Club Records', 'wp-club-manager' );?></h4>
					<p><?php _e( 'Easily view your clubs match records against your opponents with the new clubs head-to-head features. See your wins, losses and draws at a glance or view each match in more detail.', 'wp-club-manager' );?></p>

					<h4><?php _e( 'Rich Snippets for Matches', 'wp-club-manager' );?></h4>
					<p><?php _e( 'Improve your club websites SERPs with the new Rich Snippets for matches which allow search engines to gather information about your matches and display them search results.', 'wp-club-manager' );?></p>
		...
		<div class="wrap about-wrap">
			...
			<div class="changelog">
				...
				<div class="feature-section">
					...
					<p><?php _e( 'If you need more help setting up WP Club Manager, using the shortcodes and widgets or customizing the plugin templates then visit our <a href="https://wpclubmanager.com/docs/">documentation</a>.', 'wp-club-manager' );?></p>

					<h4><?php _e( 'Friendly Support','wpclubmanager' );?></h4>
					<p><?php _e( 'We do our best to provide the best support we can. If you encounter a problem or have a question, post a question in the <a href="https://wpclubmanager.com/support">support forums</a>.', 'wp-club-manager' );?></p>
